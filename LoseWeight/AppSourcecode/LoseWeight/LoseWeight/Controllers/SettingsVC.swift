...
class SettingsVC: UIViewController, MFMailComposeViewControllerDelegate
{
    ...
    {
        let alert = UIAlertController(title: "Lose Weight", message: "Are you sure you want to reset your current plan?", preferredStyle: .alert)
    ...
    @IBAction func inviteBtnAction(_ button:UIButton)
    {
        ...
        let activityViewController = UIActivityViewController(activityItems: ["Lose Weight in 7 Days App", url], applicationActivities: nil)
    ...
    func configuredMailComposeViewController() -> MFMailComposeViewController
    {
        ...
        mailComposerVC.setSubject("Lose Weight App - Feedback")
